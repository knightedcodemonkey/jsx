    ...
    worker.whenLoaded = new Promise(function (resolve2, reject) {
      var handleError2 = function (e) {
        ...
        if ('message' in e) {
          ...
          if (
            e.message.indexOf('RuntimeError') !== -1 ||
            e.message.indexOf('unreachable') !== -1
          ) {
            try {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        worker.on('error', function (e) {
          var _a, _b
          ;(_b = (_a = worker).onerror) === null || _b === void 0
            ? void 0
            : _b.call(_a, e)
        })
  ...
  function WASIThreads2(options) {
    ...
    var threadSpawn = function (startArg, errorOrTid) {
      ...
      try {
        ...
        ;(_a = _this_1.PThread) === null || _a === void 0
          ? void 0
          : _a.printErr(err.stack)
        if (isNewABI) {
...
function load(wasmInput, imports) {
  ...
  if (inputIsString || (typeof URL !== 'undefined' && wasmInput instanceof URL)) {
    ...
    if (typeof _WebAssembly2.instantiateStreaming === 'function') {
      try {
        return _WebAssembly2
          .instantiateStreaming(fetch(wasmInput), imports)
          .catch(function () {
...
function createNapiModule(options) {
  var napiModule = (function () {
    ...
    var singleThreadAsyncWork = ENVIRONMENT_IS_PTHREAD
      ? false
    ...
    function napi_adjust_external_memory(env, change_in_bytes, adjusted_value) {
      ...
      if (emnapiCtx.feature.supportBigInt) {
        var HEAP_DATA_VIEW = new DataView(wasmMemory.buffer)
        HEAP_DATA_VIEW.setBigInt64(
          adjusted_value,
          BigInt(wasmMemory.buffer.byteLength),
          true,
        )
      } else {
    ...
    var emnapiTSFN = {
      ...
      destroy: function (func) {
        ...
        if (emnapiNodeBinding) {
          ...
          var triggerAsyncId = view.getFloat64(
          ...
          var f = function () {
            envObject_1.callbackIntoModule(false, function () {
              ...
              if (callJsCb) {
                ...
                var jsCallback = js_callback
                  ? emnapiCtx.handleStore.get(js_callback).value
                  : null
          ...
          try {
            if (emnapiNodeBinding) {
              ...
              emnapiNodeBinding.node.makeCallback(resourceObject, f, [], {
                ...
                triggerAsyncId: view.getFloat64(
                  func + emnapiTSFN.offset.trigger_async_id,
                  true,
                ),
              })
    ...
    function napi_create_threadsafe_function(
      ...
      _emnapi_node_emit_async_init(
        ...
        resource_name,
        -1,
        tsfn + emnapiTSFN.offset.async_id,
      )
      HEAP_DATA_VIEW.setUint32(
        tsfn + emnapiTSFN.offset.thread_count,
        initial_thread_count,
        true,
      )
      HEAP_DATA_VIEW.setUint32(tsfn + emnapiTSFN.offset.context, context2, true)
      HEAP_DATA_VIEW.setUint32(
        tsfn + emnapiTSFN.offset.max_queue_size,
        max_queue_size,
        true,
      )
      ...
      HEAP_DATA_VIEW.setUint32(
        tsfn + emnapiTSFN.offset.finalize_data,
        thread_finalize_data,
        true,
      )
      HEAP_DATA_VIEW.setUint32(
        tsfn + emnapiTSFN.offset.finalize_cb,
        thread_finalize_cb,
        true,
      )
        ...
        var handler = function (e) {
          ...
          if (__emnapi__) {
            ...
            if (type === 'async-work-complete') {
              emnapiCtx.decreaseWaitingRequestCounter()
              emnapiAWMT.runningWorkers.splice(
                emnapiAWMT.runningWorkers.indexOf(worker),
                1,
              )
      ...
      callComplete: function (work, status) {
        ...
        try {
          if (emnapiNodeBinding) {
            ...
            var triggerAsyncId = view.getFloat64(
              work + emnapiAWMT.offset.trigger_async_id,
              true,
            )
    ...
    var emnapiString = {
      ...
      init: function () {
        ...
        var utf8Decoder
        utf8Decoder =
          typeof TextDecoder === 'function' ? new TextDecoder() : fallbackDecoder
    ...
    function napi_get_prototype(env, value, result) {
      ...
      try {
        ...
        try {
          v =
            handle.isObject() || handle.isFunction() ? handle.value : Object(handle.value)
        } catch (_) {
          return envObject.setLastError(
            2,
            /* napi_status.napi_object_expected */
      ...
      if (emnapiCtx.feature.supportNewFunction) {
        ...
        try {
          f = new Function(
            ...
            'return function ' +
              functionName +
              '(){"use strict";return _.apply(this,arguments);};',
          )(_)
        } catch (_err) {
          f = makeFunction(envObject, callback)
    ...
    function $emnapiSyncMemory(js_to_wasm, arrayBufferOrView, offset, len) {
      ...
      if (
        ...
        var pointer = emnapiExternalMemory.getArrayBufferPointer(
          arrayBufferOrView,
          false,
        ).address
      ...
      if (ArrayBuffer.isView(arrayBufferOrView)) {
        var viewPointerInfo = emnapiExternalMemory.getViewPointer(
          arrayBufferOrView,
          false,
        )
    ...
    function napi_create_external_arraybuffer(
      ...
      try {
        ...
        if (byte_length === 0) {
          ...
          u8arr.set(
            new Uint8Array(wasmMemory.buffer).subarray(
              external_data,
    ...
    function node_api_create_buffer_from_arraybuffer(
      ...
      try {
        ...
        var Buffer2 = emnapiCtx.feature.Buffer
        if (!Buffer2) {
          throw emnapiCtx.createNotSupportBufferError(
    ...
    function _emnapi_get_last_error_info(
      env,
      error_code,
      engine_error_code,
      engine_reserved,
    ...
    function node_api_is_sharedarraybuffer(env, value, result) {
      ...
      var r =
        (typeof SharedArrayBuffer === 'function' &&
          h.value instanceof SharedArrayBuffer) ||
    ...
    napiModule2.imports.napi.napi_create_threadsafe_function =
    ...
    napiModule2.imports.napi.napi_acquire_threadsafe_function =
      napi_acquire_threadsafe_function
    napiModule2.imports.napi.napi_release_threadsafe_function =
      napi_release_threadsafe_function
    napiModule2.imports.napi.napi_unref_threadsafe_function =
...
function loadNapiModuleImpl(loadFn, userNapiModule, wasmInput, options) {
  ...
  return loadFn(wasmInput, importObject, function (err, source) {
    ...
    var table = getTable
      ? getTable(originalExports)
      : originalExports.__indirect_function_table
...
var TrackedFinalizer = /* @__PURE__ */ (function (_super) {
  ...
  TrackedFinalizer2.create = function (
    envObject,
    finalize_callback,
    finalize_data,
    finalize_hint,
...
var Env = /* @__PURE__ */ (function () {
  ...
  Env2.prototype.setLastError = function (
    error_code,
    engine_error_code,
    engine_reserved,
  ) {
  ...
  NodeEnv2.prototype.callbackIntoModule = function (enforceUncaughtExceptionPolicy, fn) {
    return this.callIntoModule(fn, function (envObject, err) {
      ...
      var hasForceFlag = hasProcess
        ? Boolean(
            process.execArgv &&
            process.execArgv.indexOf('--force-node-api-uncaught-exceptions-policy') !==
              -1,
          )
        : false
      if (
...
var ReferenceWithData = /* @__PURE__ */ (function (_super) {
  ...
  ReferenceWithData2.create = function (
    envObject,
    value,
    initialRefcount,
    ownership,
    ...
    var reference = new ReferenceWithData2(
      envObject,
      value,
      initialRefcount,
      ownership,
...
var Context = /* @__PURE__ */ (function () {
  ...
  Context2.prototype.createReference = function (
    envObject,
    handle_id,
    initialRefcount,
    ownership,
...
function unsharedSlice(view, start, end) {
  return (typeof SharedArrayBuffer === 'function' &&
    view.buffer instanceof SharedArrayBuffer) ||
    Object.prototype.toString.call(view.buffer.constructor) ===
...
function wrapAsyncImport(f, parameterType, returnType) {
  ...
  return new WebAssemblyFunction({ parameters, results: returnType }, f, {
    suspending: 'first',
  })
}
...
function syscallWrap(self2, name, f) {
  ...
  if (
    typeof NODE_DEBUG_NATIVE === 'string' &&
    NODE_DEBUG_NATIVE.split(',').includes('wasi')
  ) {
    debug = true
  }
  return debug
...
var WASI$1 = class _WASI$1 {
  constructor(args, env, fds, asyncFs, fs, asyncify) {
    ...
    this.args_sizes_get = syscallWrap(
      this,
      'args_sizes_get',
      function (argc, argv_buf_size) {
        argc = Number(argc)
        ...
        view.setUint32(
          argv_buf_size,
          encoder.encode(args2.join('\0') + '\0').length,
          true,
        )
        return 0
      },
    ...
    this.environ_sizes_get = syscallWrap(
      this,
      'environ_sizes_get',
      function (len, buflen) {
        len = Number(len)
    ...
    this.clock_time_get = syscallWrap(
      this,
      'clock_time_get',
      function (id, _percision, time) {
        time = Number(time)
        if (time === 0) {
          return 28
        }
    ...
    this.fd_advise = syscallWrap(
      this,
      'fd_advise',
      function (_fd, _offset, _len, _advice) {
        return 52
      },
    )
    ...
    this.fd_fdstat_set_flags = syscallWrap(
      this,
      'fd_fdstat_set_flags',
      function (_fd, _flags) {
        return 52
      ...
      typeof crypto !== 'undefined' && typeof crypto.getRandomValues === 'function'
        ? syscallWrap(this, 'random_get', function (buf, buf_len) {
            ...
            if (
              (typeof SharedArrayBuffer === 'function' &&
                HEAPU8.buffer instanceof SharedArrayBuffer) ||
              Object.prototype.toString.call(HEAPU8.buffer) ===
                '[object SharedArrayBuffer]'
            ) {
    ...
    function defineImport(name, syncVersion, asyncVersion, parameterType, returnType) {
      if (asyncFs) {
        if (asyncify) {
          _this[name] = asyncify.wrapImportFunction(
    ...
    defineImport(
      ...
      function fd_pread(fd, iovs, iovslen, offset, size) {
        ...
        const fileDescriptor = wasi.fds.get(
          fd,
          WasiRights.FD_READ | WasiRights.FD_SEEK,
          BigInt(0),
        )
        if (!iovslen) {
    ...
    defineImport(
      ...
      async function fd_readdir(fd, buf, buf_len, cookie, bufused) {
        ...
        const fileDescriptor = wasi.fds.get(fd, WasiRights.FD_READDIR, BigInt(0))
        const fs2 = getFs(this)
        const entries = await fs2.promises.readdir(fileDescriptor.realPath, {
          withFileTypes: true,
        })
        const { HEAPU8, view } = getMemory(this)
        let bufferUsed = 0
    ...
    defineImport(
      ...
      async function path_filestat_set_times(
        fd,
        flags,
        path,
        path_len,
    ...
    function pathOpen(o_flags, fs_rights_base, fs_rights_inheriting, fs_flags) {
      const read =
        (fs_rights_base & (WasiRights.FD_READ | WasiRights.FD_READDIR)) !== BigInt(0)
      const write =
        (fs_rights_base &
          (WasiRights.FD_DATASYNC |
            WasiRights.FD_WRITE |
    ...
    defineImport(
      ...
      async function path_open(
        ...
        const pathString = decoder.decode(unsharedSlice(HEAPU8, path, path + path_len))
        const fs2 = getFs(this)
        const resolved_path = await resolvePathAsync(
          fs2,
          fileDescriptor,
          pathString,
          dirflags,
...
var WASI = class {
  ...
  finalizeBindings(instance, _a) {
    ...
    var {
      memory = (_b =
        instance === null || instance === void 0 ? void 0 : instance.exports) === null ||
      _b === void 0
        ? void 0
        : _b.memory,
    } = _a === void 0 ? {} : _a
